...
class TestMockDWaveSampler(unittest.TestCase):
    ...
    def test_custom_substitute_sampler(self):
        ...
        # Define a constant sampler that always returns the a constant (excited) state
        ...
        # First sample uses ExactSampler(); Second sampler uses constant
    ...
    def test_substitute_kwargs(self):
